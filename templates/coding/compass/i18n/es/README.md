...
└── guides/             #   Base de conocimiento (arquitectura, guías)
```
...
- **workplan/** — Gestión de tareas y base de conocimiento que el agente puede leer y actualizar
...
Basado en [Coding Compass](https://github.com/sebastianserna/ai-workflows) v1.0.0
