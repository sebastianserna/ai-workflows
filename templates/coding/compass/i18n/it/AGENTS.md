...
- Codice in inglese, documentazione e commenti in italiano

<!-- Aggiungere altre convenzioni del team. Esempio:
...
- Branch principale: `main` (PR obbligatorie)
- Branch: `feature/`, `fix/`, `hotfix/`, `refactor/`, `chore/`, `docs/` + descrizione in inglese
- Commit: Conventional Commits in inglese (`feat:`, `fix:`, `docs:`, ecc.)
- PR: titolo in inglese (Conventional Commits), descrizione/body in italiano
- Issue: titolo e descrizione in italiano
- **Non includere** `Co-Authored-By` degli agenti IA nei commit
- **Non includere** il link "Generated with Claude Code" nei messaggi di commit o PR

<!-- Aggiungere altre regole di workflow Git se necessario -->
