...
- 主分支：`main`（需要 PR）
- 分支：`feature/`、`fix/`、`hotfix/`、`refactor/`、`chore/`、`docs/` + 英文描述
- 提交：英文 Conventional Commits（`feat:`、`fix:`、`docs:` 等）
- PR：英文标题（Conventional Commits），中文描述/body
- Issue：中文标题和描述
- **不要包含**来自 AI 代理的 `Co-Authored-By`
- **不要包含** "Generated with Claude Code" 链接在提交信息或 PR 中
